...
def yolo_train(config):
    ...
    if(not os.path.exists('darknet')):
        ...
        command = "./build.sh;./darknet detector train {} {} yolov4.conv.137".format(config.voc_data_path,config.cfg_path)
...
def circumstance():
	...
	if(not os.path.exists('data/pic')):
		print('需要将训练集照片按要求放置到data/pic文件夹')
